...
class PipelineTests(unittest.TestCase):
    ...
    def test_stockq_parser_decodes_data_sq_format(self) -> None:
        page = """<table>
        <tr><td><a href='/index/TWSE.php'>台灣加權</a></td>
        <td><span class='sq-obfuscated' data-sq='MTg4NjkzNzAxMHwxOXwuMzV8NDQ3fDk2fDg3OA=='></span></td>
        <td><span class='sq-obfuscated' data-sq='NTQ4NDM4MjI4fDQ3NXwzfDk3MXwuM3wtNTg5'></span></td>
        <td><span class='sq-obfuscated' data-sq='MTk1MjEyMzMwfDB8OTE5fDN8LTEufDUzNA=='></span></td><td>08/19</td></tr>
        <tr><td><a href='/index/TWOTCI.php'>台灣櫃買</a></td>
        <td><span class='sq-obfuscated' data-sq='OTEyOTI3MzA2fC43fDMzM3w4MTV8Mzg0fDk='></span></td>
        <td><span class='sq-obfuscated' data-sq='Njc5NzkwODh8Ni58ODcxfC18ODQ2fDA0'></span></td>
        <td><span class='sq-obfuscated' data-sq='NzEwNzA0NDk3fDEuNXw5MXwtfDV8Mjkz'></span></td><td>08/19</td></tr>
        </table>"""
        records = StockQCollector._parse(page)
        self.assertEqual(len(records), 2)
        self.assertEqual((records[0]["price"], records[0]["change"], records[0]["change_percent"]), (44719.35, -589.33, -1.30))
        self.assertEqual((records[1]["price"], records[1]["change"], records[1]["change_percent"]), (384.79, -6.04, -1.55))

    def test_stockq_data_sq_rejects_malformed_payload(self) -> None:
        with self.assertRaisesRegex(ValueError, "data-sq"):
            StockQCollector._decode_payload("not-base64")
